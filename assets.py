...
def carrega_assets():
    ...
    assets[HEAD_IMG] = pygame.image.load(os.chdir(assets/imagens/'roxooficial.png')).convert_alpha()
    assets[HEAD_IMG] = pygame.transform.scale(assets[HEAD_IMG], (COBRA_WIDTH, COBRA_HEIGHT))
    assets[BODY_IMG] = pygame.image.load(os.path.join(IMG_DIR,'roxooficial.png')).convert_alpha()
